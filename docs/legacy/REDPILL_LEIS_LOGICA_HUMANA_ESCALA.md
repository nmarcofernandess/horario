# REDPILL: Leis da Lógica Humana na Escala (Jogo do Presidente)

> **Recuperado do primeiro commit** (4aea717 — 2026-02-11)
> **Origem:** `docs/ANALYST_LOGICA_HUMANA_PRIORIZACAO.md`
> **Base:** Conversa com Mãe (RH) + Conceito "Burro Bebe Água"

Este documento define as **leis de como fazer as coisas** na alocação de escala: a pirâmide de prioridade e o algoritmo de resolução de conflitos. É o "redpill" operacional do sistema.
...
"picking_rules": {
  ...
  "criteria": [
    ...
    { "field": "last_request_granted", "weight": -5 }
  ]
}
```
